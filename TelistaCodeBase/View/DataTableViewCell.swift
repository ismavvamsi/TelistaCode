...
// creating the title label programatically and adding to conatiner view
    private func createTitleLabel() {
          ...
          labelTitle.preferredMaxLayoutWidth = self.frame.size.width
            // assumes the parent view has its frame already set.
...
// creating the title label programatically and adding to conatiner view
    private func createDescLabel() {
        ...
        labelDescription.preferredMaxLayoutWidth = self.frame.size.width
        // assumes the parent view has its frame already set.
